...
func UserIDContains(v ulid.ID) predicate.Todo {
	vc := string(v)
	return predicate.Todo(sql.FieldContains(FieldUserID, vc))
}

// UserIDHasPrefix applies the HasPrefix predicate on the "user_id" field.
func UserIDHasPrefix(v ulid.ID) predicate.Todo {
	vc := string(v)
	return predicate.Todo(sql.FieldHasPrefix(FieldUserID, vc))
}

// UserIDHasSuffix applies the HasSuffix predicate on the "user_id" field.
func UserIDHasSuffix(v ulid.ID) predicate.Todo {
	vc := string(v)
	return predicate.Todo(sql.FieldHasSuffix(FieldUserID, vc))
}
...
func UserIDEqualFold(v ulid.ID) predicate.Todo {
	vc := string(v)
	return predicate.Todo(sql.FieldEqualFold(FieldUserID, vc))
}

// UserIDContainsFold applies the ContainsFold predicate on the "user_id" field.
func UserIDContainsFold(v ulid.ID) predicate.Todo {
	vc := string(v)
	return predicate.Todo(sql.FieldContainsFold(FieldUserID, vc))
}
